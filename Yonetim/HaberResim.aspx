<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HaberResim.aspx.cs" Inherits="Yonetim_GolfResim" %>
                        ...
                        <fieldset>
                            ...
                            <div>
                                <asp:Button ID="Button2" runat="server" onclick="Button2_Click" 
                                    Text="Haberi Göster" />
&nbsp;<asp:Button ID="Button3" runat="server" onclick="Button3_Click" Text="Haberi Düzenle" />
                            &nbsp;<asp:Button ID="Button4" runat="server" onclick="Button4_Click" 
                                    Text="Yeni Haber Ekle" />
                            </div>
                        </fieldset>
