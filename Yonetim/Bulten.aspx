<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bulten.aspx.cs" Inherits="Yonetim_Golf" %>
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <asp:DataGrid runat="server" ID="kayitlar" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="Isim" HeaderText="İsim Soyisim" />
                                <asp:BoundColumn DataField="EPosta" HeaderText="E-Posta Adres" />
                                ...
                                <asp:TemplateColumn HeaderText="İşlemler" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate><a class="ask" href="?Islem=sil&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/sil.png" /></a></ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
