<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BultenEkle.aspx.cs" Inherits="Yonetim_TurEkle" %>
             ...
             <div class="main_content">
                ...
                <div class="center_content">
                    ...
                    <div style="margin:10px;"> 
                        <h2>E-Bülten Ekleme</h2>
                        <fieldset>
                            <legend>E-Posta Ekle</legend>
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <b>:</b></td>
                                        <td>
                                            <asp:TextBox ID="form_isim" runat="server" Width="250px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <b>E-Posta Adresi</b></td>
                                        <td>
                                            <b>:</b></td>
                                        <td>
