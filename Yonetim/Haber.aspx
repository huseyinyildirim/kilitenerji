<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Haber.aspx.cs" Inherits="Yonetim_Tur" %>
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <asp:DataGrid runat="server" ID="kayitlar" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="Baslik" HeaderText="Haber" />
