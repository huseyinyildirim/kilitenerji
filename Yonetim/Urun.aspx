<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Urun.aspx.cs" Inherits="Yonetim_Tur" %>
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <asp:DataGrid runat="server" ID="kayitlar" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Ana Kategori">
                                    <ItemTemplate><%# Class.Fonksiyonlar.Genel.KategoriAl("" + Eval("UstID")) %></ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:BoundColumn DataField="Kategori" HeaderText="Kategori" />
                                <asp:BoundColumn DataField="Baslik" HeaderText="Ürün Adı" />
                                ...
                                <asp:TemplateColumn HeaderText="İşlemler" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate><a href="UrunResim.aspx?ID=<%# Eval("ID") %>"><img src="Library/Images/islem/resim.png" /></a> <a href="UrunDuzenle.aspx?ID=<%# Eval("ID") %>"><img src="Library/Images/islem/duzenle.png" /></a> <a class="ask" href="?Islem=sil&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/sil.png" /></a> <a class="ask" href="?Islem=durum&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/durum.png" /></a></ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
