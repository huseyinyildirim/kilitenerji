<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReferansDuzenle.aspx.cs" Inherits="Yonetim_GolfResim" %>
             ...
             <div class="main_content">
                ...
                <div class="center_content">
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <fieldset>
                            <legend>Referans Bilgileri</legend>
                    ...
                    &nbsp;<asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                                    Text="Resimi Değiştir" />
                            &nbsp;<span class="style1">(Sadece JPG uzantılı resimleri yükler.)</span></div>
                        </fieldset>
