<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Referans.aspx.cs" Inherits="Yonetim_Manset" %>
                        ...
                        <asp:DataGrid runat="server" ID="kayitlar" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Resim">
                                    <ItemTemplate><img src="/Library/Include/ResimGoster.aspx?R=/Upload/Referans/<%# Eval("Resim") %>&G=100&Y=100" /></ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:BoundColumn DataField="Baslik" HeaderText="Referans" />
                                ...
                                <asp:TemplateColumn HeaderText="İşlemler" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate><a href="ReferansDuzenle.aspx?ID=<%# Eval("ID") %>"><img src="Library/Images/islem/duzenle.png" /></a> <a class="ask" href="?Islem=sil&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/sil.png" /></a> <a class="ask" href="?Islem=durum&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/durum.png" /></a></ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
