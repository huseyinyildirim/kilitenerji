<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SayfaDuzenle.aspx.cs" Inherits="Yonetim_HaberDuzenle" %>
                ...
                <div class="center_content">
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <fieldset>
                                    ...
                                    <div>
                                        <asp:Button ID="Button4" runat="server" Text="Düzenle" 
                                            onclick="Button1_Click" />&nbsp;<asp:Button ID="Button5"
                                            runat="server" Text="Vazgeç" onclick="Button2_Click" />&nbsp;<asp:Button 
                                            ID="Button6" runat="server" onclick="Button3_Click" Text="Yeni Sayfa Ekle" />
                                    </div>
                                  </fieldset>
                            ...
                            <fieldset>
                                    ...
                                    <div>
                                        <asp:Button ID="Button1" runat="server" Text="Düzenle" 
                                            ...
                                            runat="server" Text="Vazgeç" onclick="Button2_Click" />&nbsp;<asp:Button 
                                            ID="Button3" runat="server" onclick="Button3_Click" Text="Yeni Sayfa Ekle" />
                                    </div>
                                  </fieldset>
