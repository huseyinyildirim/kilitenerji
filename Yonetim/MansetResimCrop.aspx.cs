...
public partial class Yonetim_GolfResimCrop : System.Web.UI.Page
{
    ...
    {
        example1.ImageUrl = "../Upload/Manset/" + Request.QueryString["Url"].ToString() + "";
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        System.Drawing.Image image = Bitmap.FromFile(Server.MapPath("~/Upload/Manset/" + Request.QueryString["Url"].ToString() + ""));
        ...
        bmp.Save(Server.MapPath("~/Upload/Manset/" + Request.QueryString["Url"].ToString().Replace("_", "") + ""), image.RawFormat);
        bmp.Dispose();
        ...
        Response.Redirect("MansetDuzenle.aspx?ID=" + Request.QueryString["ID"] + "");
    }
}