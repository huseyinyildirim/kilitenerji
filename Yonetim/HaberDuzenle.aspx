<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HaberDuzenle.aspx.cs" Inherits="Yonetim_HaberDuzenle" %>
             ...
             <div class="main_content">
                ...
                <div class="center_content">
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <fieldset>
                            <legend>Haber Bilgileri</legend>
                            <div>
                                <table>
                                    <tr>
                                        <td>
                                            <b>Haber Başlığı</b></td>
                                        <td>
                                            <b>:</b></td>
                                        <td>
                        ...
                        <fieldset>
                                    ...
                                    <div>
                                        ...
                                        &nbsp;<asp:Button ID="Button7"
                                            ...
                                            ID="Button8" runat="server" onclick="Button4_Click" Text="Yeni Haber Ekle" />
                                    </div>
                                  </fieldset>

                                  <fieldset>
                                    <legend>Özet</legend>
                                    <div><CKEditor:CKEditorControl ID="form_ozet" Width="98%" runat="server" 
                                      ...
                                      Toolbar="Basic" ToolbarCanCollapse="False" ToolbarFull="Source|-|Preview|
...
TextColor|BGColor
Maximize|ShowBlocks|" Height="100px" ShiftEnterMode="DIV"></CKEditor:CKEditorControl></div>
                                  </fieldset>
                            ...
                            <fieldset>
                                    ...
                                    <div>
                                        ...
                                        &nbsp;<asp:Button ID="Button2"
                                            runat="server" Text="Vazgeç" onclick="Button2_Click" />&nbsp;<asp:Button 
                                            ID="Button4" runat="server" onclick="Button4_Click" Text="Yeni Haber Ekle" />
                                    </div>
                                  </fieldset>
