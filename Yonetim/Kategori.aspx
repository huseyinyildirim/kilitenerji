<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Kategori.aspx.cs" Inherits="Yonetim_Tur" %>
                    ...
                    <div style="margin:10px;"> 
                        ...
                        <asp:DataGrid runat="server" ID="kayitlar" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="UstKategori" HeaderText="Üst Kategori" />
                                <asp:BoundColumn DataField="Baslik" HeaderText="Kategori" />
                                ...
                                <asp:TemplateColumn HeaderText="İşlemler" ItemStyle-Width="80" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate><a href="KategoriDuzenle.aspx?ID=<%# Eval("ID") %>"><img src="Library/Images/islem/duzenle.png" /></a> <a class="ask" href="?Islem=sil&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/sil.png" /></a> <a class="ask" href="?Islem=durum&ID=<%# Eval("ID") %>"><img src="Library/Images/islem/durum.png" /></a></ItemTemplate>
                                </asp:TemplateColumn>
                            </Columns>
